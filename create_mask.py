# CREDIT: https://github.com/savankoradiya/Extract-Mask-From-COCO-Dataset/blob/master/extract_mask_from_coco.py
...
seg_output_path = 'dataset/coco/seg'

original_img_path = 'dataset/coco/img'
